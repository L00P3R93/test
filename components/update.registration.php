<?php
    ...
    if(isset($_POST)){
        ...
        $sql4="INSERT INTO users (f_name,l_name,id,email,phone,gender,avatar) VALUES ('$user_firstname','$user_lastname','$user_id_no','$user_email','$user_phone','$gender','$NewImageName') WHERE username = '$temp'";
        ...
        if( mysqli_num_rows($result) > 0) {
            ...
            header("location:../home.php?user_name=$temp&level=user");
        }
        else{
