<?php
    ...
    if(isset($_REQUEST['signup_button'])){
        ...
        $sql1="INSERT INTO users(username,password,reset_phrase,f_name,l_name,email) VALUES('$user_name','$user_password2','$reset','$user_firstname','$user_lastname','$user_email')";
